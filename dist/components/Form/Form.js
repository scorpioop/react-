...
export var Form = forwardRef(function (props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { name: name, onSubmit: handleSumbit },
            React.createElement(FormContext.Provider, { value: passValue }, children)),
        React.createElement("div", null, JSON.stringify(store))));
});
Form.defaultProps = {
    name: "form"
};
